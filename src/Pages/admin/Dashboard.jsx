...
import AdminDonationItemDetail from "./DonationItems/AdminDonationItemDetail";

export default function AdminDashboard() {
  const [activeMenu, setActiveMenu] = useState(null);
  const [isSidebarOpen, setIsSidebarOpen] = useState(true);
  const [selectedDonationItemId, setSelectedDonationItemId] = useState(null);
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenuItems: [
        ...
        { title: "Manage item donation", path: "/manage-donation-items" },
  ...
  const handleDonationItemSelect = (itemId) => {
    setSelectedDonationItemId(itemId);
    setActivePath("/donation-item-detail");
  };
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {activePath !== "/dashboard" && (
              <div className="bg-gray-100 p-4 rounded-lg">
                ...
                {activePath === "/manage-donation-items" && (
                  <AdminDonationItems onItemSelect={handleDonationItemSelect} />
                )}
                {activePath === "/donation-item-detail" &&
                  selectedDonationItemId && (
                    <AdminDonationItemDetail
                      id={selectedDonationItemId}
                      onBack={() => setActivePath("/manage-donation-items")}
                    />
                  )}
              </div>
            )}
