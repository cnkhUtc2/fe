...
export const updateReliefCaseUser = async (id, data) => {
  try {
    const res = await apiClient.put(`/front/relief-cases/update/${id}`, data);
    return res.data;
  } catch (error) {
    handleApiError(error);
  }
...
export const getAllReliefCases = async (params) => {
  try {
    const res = await apiClient.get(`/front/relief-cases`, { params });
    return res.data;
  } catch (error) {
    handleApiError(error);
  }
...
export const getReliefCase = async (id) => {
  try {
    const res = await apiClient.get(`/front/relief-cases/${id}`);
    return res.data;
  } catch (error) {
    handleApiError(error);
  }
